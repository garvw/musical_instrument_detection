...
2. **Download the Model:** Click here to download the pre-trained `instrument_model.keras` file from [Google Drive]([[LINK HERE]](https://drive.google.com/drive/folders/1gFpMn0pdYeu9Eq2Tuv72Bxqb0T5voENF)). 
3. **Move the file:** Place that downloaded `.keras` file in the exact same folder as the Jupyter Notebook on your computer.
4. **Install dependencies:** Open your terminal and run:
