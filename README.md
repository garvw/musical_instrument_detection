...
1. **Download the Model:** Click here to download the pre-trained `instrument_model.keras` file from [Google Drive]([[LINK HERE]](https://drive.google.com/drive/folders/1gFpMn0pdYeu9Eq2Tuv72Bxqb0T5voENF)). 
